...
Merge Inspector, KAT, and Merqury into one how to. Run all three on the chiridota heheva long read genomes. Be sure to include the published assembly in the analysis. 
