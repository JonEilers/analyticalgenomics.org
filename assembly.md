...
### need to write more about how genomes are assembly from an basic algorithm stand point. maybe write a separate page on it? Enough so people understand from a conceptual viewpoint
...
these might be a good candiditate for reassembly
https://www.ncbi.nlm.nih.gov/bioproject/PRJEB10682/

and this - except it has super low coverage
https://www.ncbi.nlm.nih.gov/assembly/GCA_010015985.1#/st

hmmm, this has good coverage. but I doubt I will be able to match their n50 even if it is suspicious
https://www.ncbi.nlm.nih.gov/sra?linkname=bioproject_sra_all&from_uid=525091
...
Note: for both the apostichopus japonicus and parvimensis, the pacbio reads only have 10x-20x coverage and both were insufficient for good assembly by themselves using raven or canu. should probably talk about that
...
[Comparison of three long read genome assemblers](/longread_genome_assembly/)

raven - note it uses racon for polishing
shasta 
canu takes too long
flye

good shasta paper: https://www.nature.com/articles/s41587-020-0503-6


raven paper: https://www.nature.com/articles/s43588-021-00073-4 

probably run a few rounds of polishing with hapo-g after?
...
TGS-Gapcloser -https://academic.oup.com/gigascience/article/9/9/giaa094/5902284
long read gap closer - using racon and pilon though for polishing ugh. 

dentist too

GAPPadder - https://bmcgenomics.biomedcentral.com/articles/10.1186/s12864-019-5703-4 
short read gap closer - unmaintained
...
hapo-g 
TGSS--gapcloser - https://www.biorxiv.org/content/10.1101/831248v1.abstract
and dentist
...
dentist paper: https://www.biorxiv.org/content/10.1101/2021.02.26.432990v1.full


SSpace - https://academic.oup.com/bioinformatics/article/27/4/578/197626
don't use this. ugh. maybe work up an example of why? 
github of last opensource version
https://github.com/nsoranzo/sspace_basic

hmmm maybe play with AGB for visualizing long read assembly?
